...
export class Level1Component implements OnInit{
  ...
  username: string = '';
    ...
    ngOnInit(): void {
      ...
      this.text1 = new fabric.Text('Level - 1', {fontSize: 25,fontWeight:'bold', selectable:!1,hasControls:!1},);
      ...
      this.text7 = new fabric.Text('Height - x cm ', {fontSize: 20,
        left: 110,
        top: 320,selectable:!1,hasControls:!1});
      this.canvas.add(this.text7);
      this.text8 = new fabric.Text('Height - 5 cm ', {fontSize: 20,
        left: 550,
        top: 320,selectable:!1,hasControls:!1});
