...
export class Level2Component implements OnInit{
  ...
  username: string = '';
    ...
    ngOnInit(): void {
      ...
      this.text1 = new fabric.Text('Level - 2', {fontSize: 25,fontWeight:'bold', selectable:!1,hasControls:!1},);
      this.canvas.add(this.text1);
      this.text4 = new fabric.Text('Image screen ', {fontSize: 20,
        left: 110,
        top: 300,selectable:!1,hasControls:!1});
      this.canvas.add(this.text4);
      this.text5 = new fabric.Text('Pinhole screen ', {fontSize: 20,
        left: 325,
        top: 300,selectable:!1,hasControls:!1});
      this.canvas.add(this.text5);
      this.text6 = new fabric.Text('Object screen ', {fontSize: 20,
        left: 550,
        top: 300,selectable:!1,hasControls:!1});
  ...
  this.route.queryParams.subscribe(params => {
    ...
    adjustHolePosition(): void {
      // Define the logic to adjust the hole position
      console.log('Adjusting hole position...');
      // Add your implementation here
    }
  
    addAHole(holeNumber: number): void {
      // Define the logic to add a hole
      console.log('Adding a hole with number:', holeNumber);
      // Add your implementation here
    }
}
